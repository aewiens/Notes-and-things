...
%One can apply the Slater Rules (or Wick's theorem) to the first and third
...
\newpage
%\subsection*{CEPA(0) Appendix}
%The simplest CEPA technique, known as CEPA(0), simply assumes $\Delta_{{L}} =
